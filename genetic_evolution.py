...
def main():
	with open('Games\\generation_2.txt', 'r+') as file:
		games = file.read()
	...
	#bob = load_model('Models\\bob_gen_1.h5')

	print "--------------------EVOLVING----------------------"

	evolving = sys.argv[1]
	if evolving == 'white':
		walt_child_1 = load_model('Models\\walt_gen_1.h5')
		...
		walt_child_2 = load_model('Models\\walt_gen_1.h5')
		...
		walt_child_3 = load_model('Models\\walt_gen_1.h5')
		...
		walt_child_4 = load_model('Models\\walt_gen_1.h5')
		...
		bob_child_1 = load_model('Models\\bob_gen_1.h5')
		...
		bob_child_2 = load_model('Models\\bob_gen_1.h5')
		...
		bob_child_3 = load_model('Models\\bob_gen_1.h5')
		...
		bob_child_4 = load_model('Models\\bob_gen_1.h5')
	...
	with open('Games\\generation_2.txt', 'w+') as file:
		file.write(str(games))

	#bob.save('Models\\bob.h5')
	for i in range(len(results)):
		if results[i] == 'black':
			childs[i].save(r'Models\bob_gen_2_child_' + str(i) + '.h5')
